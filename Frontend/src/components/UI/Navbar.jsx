    ...
    <>
      <header className="bg-amber-100 p-4 flex justify-between items-center shadow-md relative z-50">
        ...
        <nav className="hidden md:flex space-x-4">
          {isAuthenticated ? (
            <>
              <NavLink to="/Home" end className="px-4 py-2 text-gray-700 hover:text-black transition hover:bg-amber-200 rounded-3xl">
                Home
              </NavLink>
              <NavLink to="/overall" className="px-4 py-2 text-gray-700 hover:text-black transition hover:bg-amber-200 rounded-3xl">
                Overall
              </NavLink>
              <NavLink to="/profile" className="px-4 py-2 text-gray-700 hover:text-black transition hover:bg-amber-200 rounded-3xl">
                Profile
              </NavLink>
              <button 
                onClick={handleLogout} 
                className="px-4 py-2 text-gray-700 hover:text-black transition hover:bg-red-200 rounded-3xl"
              >
                Logout
              </button>
            </>
